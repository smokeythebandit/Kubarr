...
The catalog is populated from the Helm charts in the [kubarr-charts](https://github.com/bmartensNL/kubarr-charts) repository and kept in sync automatically. You can also trigger a manual sync from the UI.
...
1. Kubarr pulls the latest chart from the OCI registry at `ghcr.io/bmartensnl/kubarr-charts`
...
Every app in the catalog is backed by a Helm chart in the [kubarr-charts](https://github.com/bmartensNL/kubarr-charts) repository. Charts are published to an OCI registry and versioned independently.
