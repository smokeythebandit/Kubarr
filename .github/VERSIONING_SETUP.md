...
**View Settings**: https://github.com/smokeythebandit/Kubarr/settings/branches
...
**View Settings**: https://github.com/smokeythebandit/Kubarr/rules/12880007

### 3. Pull Request Created ✅

**PR #22**: Add versioning system with release channels
- URL: https://github.com/smokeythebandit/Kubarr/pull/22
...
```bash
gh api repos/smokeythebandit/Kubarr/branches/main/protection
```
...
gh api \
  --method PUT \
  repos/smokeythebandit/Kubarr/branches/main/protection \
...
gh api \
  --method DELETE \
  repos/smokeythebandit/Kubarr/branches/main/protection/enforce_admins
```
...
- Open an issue: https://github.com/smokeythebandit/Kubarr/issues
- Review the PR: https://github.com/smokeythebandit/Kubarr/pull/22
