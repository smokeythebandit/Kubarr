...
#[openapi(
    ...
    paths(
        ...
        apps::gpu_nodes,
        apps::install_app,
        apps::list_operations,
        apps::get_operation,
        apps::pause_operation,
        apps::resume_operation,
        apps::cancel_operation,
        apps::retry_operation,
        apps::list_app_states,
        apps::get_app_state,
        apps::update_app,
        apps::delete_app,
        apps::restart_app,
...
pub fn create_router(state: AppState) -> Router {
    // Health routes stay public for Kubernetes probes and CI readiness checks.
    ...
    // Merge API routes only. Frontend and app proxying are handled by the gateway.
    health_routes
        .merge(public_routes)
